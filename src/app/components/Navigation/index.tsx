...
const Navigation = () => {
  ...
  const [avatar, setAvatar] = useState(null); // State to manage avatar image
  ...
  return (
    <header
      className={`fixed shadow-sm left-0 -top-2 z-99999 w-full py-2 ${stickyMenu
    ...
    >
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          ...
          {/* shop logo  */}
          <a href="/" className="text-xl smt-2">
            {/* Light Mode Logo */}
            <img
        ...
        <div className="relative items-center gap-2 sm:hidden xl:block md:hidden hidden">
