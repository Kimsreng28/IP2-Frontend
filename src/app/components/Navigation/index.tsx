...
const Navigation = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 z-99999 w-full py-7 font-poppins ${stickyMenu ? "bg-white !py-2 shadow transition duration-100 dark:bg-black" : ""}`}
    >
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 font-poppins md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between font-poppins xl:w-1/4">
        ...
        >
          <nav>
            <ul className="mr-[300px] flex flex-col gap-5 font-poppins xl:flex-row xl:items-center xl:gap-10">
                  ...
                  <Link
                    ...
                    className={
                      currentPath === menuItem.path
                        ? "rounded-full py-2 font-semibold dark:bg-[#343c5c]"
                        : ""
                    }
                  >
                    {menuItem.title}
