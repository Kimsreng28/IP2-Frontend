...
export default function DeliveryLayout({
  ...
  const steps = [
    { id: "orderCompleted", name: "Order Completed", path: "delivery" },
    { id: "shipped", name: "Shipped", path: "shipped" },
    { id: "outOfDelivery", name: "Out Of Delivery", path: "outOfDelivery" },
    { id: "delivery", name: "Delivery", path: "deliveryOrder" },
  ];
          ...
          <div className="mx-auto max-w-6xl ">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="text-lg font-medium text-gray-800 dark:text-white">
                Order Code: <span className="font-semibold">{productId}</span>
              </div>

              <button className="inline-flex items-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
            ...
            >
              <div className="mt-10 flex items-center justify-between">
                {steps.map((step, index) => {
                  ...
                  const isCompleted =
                    index === 0 || steps.indexOf(currentStep) > index;

                  return (
                    <div key={step.id} className="flex flex-col items-center">
                      <Link
                        href={`/client/pages/shop/view/${productId}/delivery/${step.path}`}
